...
function solvent_batch(dir::AbstractString, soluteprefix::AbstractString, solventprefix::AbstractString="solvent")
    ...
    for i = 1:nsolute
        ...
        isfile(outputfn) ? @warn("$outputfn exists, skipped ... ") : make_solvent(joinpath(dir, s), outputfn);
    end
